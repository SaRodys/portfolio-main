    ...
    this.innerHTML = `
      <footer class="bg-menu p-4 justify-content-center text-center row m-0">
        <div class="bg-menu mt-5 mb-5 col-12 col-lg-4 text-lg-center m-lg-0 ">
            <h2 class="bg-menu text-clight p-lg-4 reduce-font">Contatti</h2>
        ...
        <div class="bg-menu mb-5 col-12 col-lg-4 text-lg-center border-lg-start border-lg-end pb-lg-5">
            <h2 class="bg-menu text-clight p-lg-4 reduce-font">Social</h2>
        ...
        <div class="bg-menu mb-5 col-12 col-lg-4 text-lg-center">
            <h2 class="bg-menu text-clight p-lg-4 reduce-font">Portfolio</h2>
        ...
        <h6 class="bg-menu text-clight col-12">© 2025 - Sara Rodigari - Tutti i diritti riservati</h6>
      </footer>
    `;
  }
}
